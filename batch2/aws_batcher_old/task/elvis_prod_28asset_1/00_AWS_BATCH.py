...
###### Update those data    -------------------------------------------------------
######  NEVER PUT ABSOLUT Path due to Remote Folder, Only relative to Python Folder
params={
...
#### relative to DIRBATCH
'filedata'  :              'close_28assets_2012_jan2017.spydata',
'input_params_file':       'input_params_all.pkl',
...
task1_name=       params['task1_name']                           # Folder of  linux/batch/task/
DIRBATCH_local=   DIRCWD + '/linux/batch/task/' + task1_name     #
globals().update(params)
util.os_config_setfile(params, DIRBATCH_local + '/ec2_config.py', mode1='w+')


############# 2) Test in local linux terminal      ############################################
'''
ipython  /media/sf_project27/linux/batch/task/elvis_prod_28asset_1/subprocess_launcher_01.py

###Individual task
ipython /media/sf_project27/linux/batch/task/elvis_prod_28asset_1/pygmo_batch_generic.py "(('/media/sf_project27//linux/batch/task/elvis_prod_28asset_1/input_params_all.pkl', 0, 2), '0,0')"

'''



#### 3) Create  Spot Instance  #############################################################
...
####Check Params    ----------------------------------------------------------------------
util.os_config_getfile(DIRBATCH_local + '/ec2_config.py')
print 'Dir Batch Local:', DIRBATCH_local,'\n',
...
print(EC2CWD + '/linux/batch/task/' + task1_name + '/subprocess_launcher_01.py')
ssh= util.aws_ec2_ssh(host)
ssh.python_script(EC2CWD + '/linux/batch/task/' +task1_name + '/subprocess_launcher_01.py', 'args1')
...
#Check in Remote Linux   ############################################

ipython /home/ubuntu/notebook//linux/batch/task/elvis_prod_28asset_1/pygmo_batch_generic.py "(('/home/ubuntu/notebook//linux/batch/task/elvis_prod_28asset_1/input_params_all.pkl', 0, 0), '0,0')"

ipython  /home/ubuntu/notebook//linux/batch/task/elvis_prod_28asset_1/subprocess_launcher_01.py


ipython   /home/ubuntu/notebook//linux/batch/task/elvis_prod_28asset_1/pygmo_batch_generic.py "(('/home/ubuntu/notebook//linux/batch/task/elvis_prod_28asset_1/input_params_all.pkl', 12, 14), '0,0')"
