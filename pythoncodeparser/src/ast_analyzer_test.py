...
""")
        ...
        want = [("(global)", "__name__", False), ("(global)", "hello", False), ("hello", "msg", True),
                ("hello", "print", False)]

        got = sorted((function_or_class.name if function_or_class is not None else "(global)", variable_name, is_local)
