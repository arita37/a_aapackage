...
class SGXDataExtract(WebJsonRetrieval):
    ...
    def shortsell_notification(self):
        ...
        top_shortsell_df = merged_shortsell_df[merged_shortsell_df['ranked_shortsell'].isin(list(range(1,16)))]
        ...
        tar_watchlist_shortsell_df =tar_watchlist_shortsell_df[tar_watchlist_shortsell_df['ranked_shortsell'].isin(list(range(1,100)))]
