...
##        self.hist_database_path = r'C:\data\stock_sql_db\stock_hist.db'
        ...
        self.hist_quotes_csvfile_path = os.getcwd()+'/aapackage/data/temp/raw_stock_data.csv' # for storing of all stock raw data
        self.tempfile_sav_location =   os.getcwd()+'/aapackage/data/temp/temp_hist_div_data_save.csv'
