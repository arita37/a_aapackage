...
class QA:
    def __init__(self, vocab_size):
        ...
        self.cost = tf.reduce_mean(tf.contrib.seq2seq.sequence_loss(logits = decoder_output.rnn_output,
