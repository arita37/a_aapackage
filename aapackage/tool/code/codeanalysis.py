...
jedi._compatibility.Python3Method.__init__(self, func)
...
jedi.api.interpreter.underscore_memoization(func)
...
jedi.cache.cache_star_import(func)
...
jedi.common.reraise_uncaught(func)
jedi.common.safe_property(func)
...
jedi.evaluate.compiled.CheckAttribute.__init__(self, func)
...
jedi.evaluate.iterable.Generator.__init__(self, evaluator, func, var_args)
...
jedi.evaluate.param.Arguments.unpack(self, func)
...
jedi.evaluate.param._error_argument_count(func, actual_count)
jedi.evaluate.param._get_calling_var_args(evaluator, var_args)
jedi.evaluate.param._iterate_star_args(evaluator, array, input_node, func)
jedi.evaluate.param._star_star_dict(evaluator, array, input_node, func)
jedi.evaluate.param.get_params(evaluator, func, var_args)
jedi.evaluate.param.underscore_memoization(func)
...
jedi.evaluate.recursion.execution_recursion_decorator(func)
jedi.evaluate.recursion.recursion_decorator(func)
...
jedi.evaluate.representation.Function.__init__(self, evaluator, func, is_decorated)
...
jedi.evaluate.representation.Instance._get_func_self_name(self, func)
jedi.evaluate.representation.Instance.wrapper(obj)
...
jedi.evaluate.representation.Python3Method.__init__(self, func)
...
jedi.evaluate.representation.cache_star_import(func)
...
jedi.evaluate.representation.underscore_memoization(func)
...
jedi.parser.tree.Python3Method.__init__(self, func)
...
jedi.parser.tree.utf8_repr(func)
