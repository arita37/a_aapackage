...
def test(filename= 'dataset/GOOG-year.csv') :
    ...
    module, model =create('23_lstm-luong.py',{"epoch": 1, "timestep": 5.0, "learning_rate": 0.01, "num_layers": 1.0, "size": df_log.shape[1], "size_layer": 128.0, "output_size": df_log.shape[1]})
