...
class Model:
    def __init__(self, learning_rate, num_layers, size, size_layer, output_size, forget_bias = 0.1,
                attention_size = 10, epoch=1, timestep=5):
...
def test(filename= 'dataset/GOOG-year.csv') :
    ...
    module, model =create('24_lstm-luong-bahdanau.py',{"epoch": 1, "timestep": 5.0, "learning_rate": 0.01, "num_layers": 1.0, "size": df_log.shape[1], "size_layer": 128.0, "output_size": df_log.shape[1]})
