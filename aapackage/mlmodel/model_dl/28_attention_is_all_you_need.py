...
def test(filename= 'dataset/GOOG-year.csv') :
    ...
    module, model =create('28_attention_is_all_you_need.py',{"epoch": 1, "timestep": 5, "size_layer": 128, "embedded_size": 128, "learning_rate": 0.001, "size": df_log.shape[1], "output_size": df_log.shape[1]})
...
if __name__ == "__main__":
    ...
    modelnn = Model(embedded_size, embedded_size, learning_rate, df_log.shape[1], df_log.shape[1], epoch=epoch, timestep=timestamp)
