...
def test(filename= 'dataset/GOOG-year.csv') :
    ...
    module, model =create('18_lstm_attention_scaleddot.py',{"learning_rate": 0.01, "num_layers": 1, "size": df_log.shape[1], "size_layer": 128, "output_size": df_log.shape[1], "seq_len": 5, "epoch": 1})
