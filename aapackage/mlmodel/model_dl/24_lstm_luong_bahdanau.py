...
def test(filename= 'dataset/GOOG-year.csv') :
    ...
    module, model =create('24_lstm_luong_bahdanau.py',{"epoch": 1, "timestep": 5, "learning_rate": 0.01, "num_layers": 1, "size": df_log.shape[1], "size_layer": 128, "output_size": df_log.shape[1]})
