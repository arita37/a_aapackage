...
def test(filename= 'dataset/GOOG-year.csv') :
    ...
    module, model =create('21_multihead_attention.py',{"epoch": 1, "seq_len": 5, "learning_rate": 0.01, "dimension_input": df_log.shape[1], "dimension_output": df_log.shape[1], "num_heads":df_log.shape[1]})
