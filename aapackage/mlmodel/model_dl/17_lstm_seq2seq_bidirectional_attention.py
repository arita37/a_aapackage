...
def test(filename= 'dataset/GOOG-year.csv') :
    ...
    module, model =create('17_lstm_seq2seq_bidirectional_attention.py',{"learning_rate": 0.01, "num_layers": 1, "size": df_log.shape[1], "size_layer": 128, "output_size": df_log.shape[1], "epoch": 1})
