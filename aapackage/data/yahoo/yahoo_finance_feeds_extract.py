...
class YFinanceFeedsExtr(object):
    ...
    def form_url_str(self):
        ...
        self.feeds_full_url = (
            self.feeds_start_url
            + self.feeds_stock_portion_url
            + self.feeds_stock_portion_additional_url
            + self.feeds_end_url
        )
    ...
    def parse_xml_file(self):
        ...
        for n in reader.entries:
            ...
            if date_key in self.feeds_dict[self.individual_stock_sym]:
    ...
    def calculate_start_and_end_date(self):
        ...
        start_date_num = int(
            str(start_date_tuple[0]) + str(start_date_tuple[1]) + str(start_date_tuple[2])
        )
    ...
    def print_feeds_for_one_stock(self, sym):
        ...
        for datekey in list(all_feeds_for_indivdual_stock.keys()):
