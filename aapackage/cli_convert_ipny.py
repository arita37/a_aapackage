...
def load_arguments():
  ...
  parser.add_argument("-i", "--in_folder",  default="out_folder", help="path to task folder.")
  parser.add_argument("-o", "--out_folder", default="in_folder", help=".")
...
def Run():
    ...
    for s in error_list:
        os.remove(s)
    print('%d were converted successfully, %d cause error'%(len(dst_files)-len(error_list), len(error_list)))
