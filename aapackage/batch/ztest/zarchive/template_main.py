...
def batch_execute_parallel(
    HyperParametersFile, WorkingDirectory, subprocess_script, batch_log_file="batch_logfile.txt"
):
    """
    ...
    for ii in range(HyperParameters.shape[0]):
        ...
        proc = subprocess.Popen([python_path, subprocess_script, str(ii)], stdout=subprocess.PIPE)
