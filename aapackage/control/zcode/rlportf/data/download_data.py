        ...
        for market in market_types:
            if market == "stock":
                ...
                for stock in stock_list:
                    ...
                    self.stock_data.extend(
                        ts.get_k_data(stock, start=start_date, end=end_date, ktype=ktype).values
                    )

    def save_data(self):
        pd.DataFrame(
            self.stock_data, columns=["time", "open", "close", "high", "low", "volume", "code"]
